...
$initConfig = [
    ...
    "params"   =>  [
        ...
        'socket_config' => [
            ...
            'dispatch_mode'    => 2,
            'daemonize'        => 1,
            'log_file'         => '/var/log/swoole/swoole_socket_test.log',
            'pid_file'         => '/var/log/swoole/swoole_socket_test_pid.log',
            'log_size'         => 204800000,
        ...
        'proxy_config' => [
            ...
            'dispatch_mode'    => 2,
            'daemonize'        => 1,
            'log_file'         => '/var/log/swoole/swoole_proxy_test.log',
            'pid_file'         => '/var/log/swoole/swoole_proxy_test_pid.log',
            'log_size'         => 204800000,
            'log_dir'          => '/var/log/swoole',
            'open_eof_split'   => true,
            'package_eof'      => "\r\n\r\n",
